...
#tiff("XGBoost August ROC.tiff", height = 180, width = 180, units = 'mm', res = 90) #save as tiff
par(mfrow=c(2,2))
...
#results= c("UHealSesn AUC" = roc.UHealSesn$auc,"Moderate AUC" = roc.Moderate$auc,"Good AUC" = roc.Good$auc)
#print(results)
legend("bottomright",c("UHealSesn","Moderate","Good"),fill=c("red","#FF9900","green"), cex = 0.7)
#legend("bottomright",c("UHealSesn","Moderate","Good"),fill=c("red","#FF9900","green"),inset = (0.46), cex = 0.7)
...
# Plot Maps
print(spplot(r_ave_UHealSesn, main="UHealSesn August XGB"))
#writeRaster(r_ave_Moderate,filename="Prediction_XGBoostTunned_Ave_Moderate.tif", format="GTiff", overwrite=TRUE) 

print(spplot(r_ave_Moderate, main="Moderate August XGB"))
#writeRaster(r_ave_UHealSesn,filename="Prediction_XGBoostTunned_Ave_UHealSesn.tif", format="GTiff", overwrite=TRUE) 

print(spplot(r_ave_good, main="GOOD August XGB"))
...
# Plot Map
LU_ave<-spplot(r_ave,"Level_ID", main="PM10 ave. concentration prediction: XGBoost August" , 
